...
if n_positive_train == 0 or n_positive_test == 0:
    print(f"\n⚠️  WARNING: Insufficient positive samples in train or test split")
...
print(f"  F1 at P≥0.80: {f1_lr:.4f} (Precision: {prec_lr:.2f}, Recall: {rec_lr:.2f})")
...
print(f"  F1 at P≥0.80: {f1_lgb:.4f} (Precision: {prec_lgb:.2f}, Recall: {rec_lgb:.2f})")
