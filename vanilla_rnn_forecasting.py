"""
Phase 4e: Vanilla RNN Forecasting & Backtesting
Rolling window forecasting with Vanilla RNN models
"""
...
print("="*80)
print("PHASE 4e: VANILLA RNN ROLLING WINDOW FORECASTING")
print("="*80)
...
# ============================================================================
# VANILLA RNN MODEL ARCHITECTURE (must match phase3e)
# ============================================================================
...
for country in countries:
    ...
    forecast_df.to_csv(f'results/phase3e_vanilla_rnn_results/forecast_{country}.csv')
...
with open('results/phase3e_vanilla_rnn_results/metrics_summary.json', 'w') as f:
...
comparison_df.to_csv('results/phase3e_vanilla_rnn_results/metrics_comparison.csv', index=False)

print("\n" + "="*80)
print("VANILLA RNN FORECAST METRICS")
print("="*80)
...
for country in countries:
    ...
    ax.plot(timestamps, results['forecasts'], label='Vanilla RNN Forecast', linewidth=2, alpha=0.8)
    
    metrics = results['metrics']
    title = f"{country} - Vanilla RNN Forecast: MAPE={metrics['MAPE_%']:.2f}%, RMSE={metrics['RMSE_MW']:.1f} MW, MASE={metrics['MASE']:.4f}"
...
print("="*80)
print("\nResults saved to: results/phase3e_vanilla_rnn_results/")
