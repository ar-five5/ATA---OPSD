...
def fit_sarima_model(train_data, p, d, q, P, D, Q, s, country):
    """
    Fit a single SARIMA model and return results.
...
# ============================================================================
# TASK 1: DATA SPLIT (80% Train, 10% Dev, 10% Test)
# ============================================================================
print("\n[2/5] Splitting data: 80% Train, 10% Dev, 10% Test (chronological)...")
...
for country, load_col in load_columns.items():
    ...
    # Use only last 120 days of data for faster computation
    # 120 days = 120*24 = 2,880 hours (2x the 60 days PDF minimum)
    hours_120_days = 120 * 24
    if len(data) > hours_120_days:
        data = data.iloc[-hours_120_days:]
        print(f"\n{country}: Using last 120 days of data ({len(data):,} hours)")
...
# ============================================================================
# TASK 2: SARIMA GRID SEARCH WITH AIC/BIC
# ============================================================================
print("\n[3/5] Performing SARIMA grid search with AIC/BIC...")
        ...
        try:
            ...
            parallel_results = Parallel(n_jobs=n_jobs, verbose=10)(
                delayed(fit_sarima_model)(
                    train_data, p, d, q, P, D, Q, s, country
